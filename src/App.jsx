...
const SITUATION_DB = {
  ...
  1: [
    ...
    { id:"ci08", idiom:{word:"지성감천(至誠感天)", meaning:"지극한 정성은 하늘도 감동시킨다"}, title:"삼고초려의 진심", era:"207년", scene:"융중 초당",
      ...
      options:[
        { cji:"天", text:"세 번 찾아가며 포기하지 않는다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:96 },
        { cji:"地", text:"상대가 원하는 것을 먼저 파악해 제공한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"대의를 설명하고 함께할 것을 청한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ci09", idiom:{word:"인재천거(人才薦擧)", meaning:"인재를 알아보는 눈이 가장 큰 능력이다"}, title:"순욱의 인재 추천", era:"196년", scene:"허도",
      ...
      options:[
        { cji:"天", text:"인재를 잘 대우해 좋은 평판을 만든다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"추천 인재의 성과를 공개적으로 칭찬한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"인재 추천 시스템을 제도화한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ci10", idiom:{word:"관인대도(寬仁大度)", meaning:"너그러운 인자함과 큰 아량으로 사람을 얻는다"}, title:"여포의 배신과 조조의 대응", era:"199년", scene:"하비성 함락 후",
      ...
      options:[
        { cji:"天", text:"용기와 능력을 인정하고 전향을 권유한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"충성을 시험하며 점진적으로 신뢰한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"중요 임무를 주어 능력을 검증한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ci11", idiom:{word:"충심(忠心)", meaning:"충성하는 마음은 어떤 상황에서도 변하지 않는다"}, title:"제갈량의 출사표 작성", era:"227년", scene:"성도",
      ...
      options:[
        { cji:"天", text:"행동으로 증명한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"말과 글로 분명히 표현한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"묵묵히 맡은 바를 다한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ci12", idiom:{word:"원려심모(遠慮深謀)", meaning:"멀리 생각하고 깊이 도모하는 것이 지략의 핵심"}, title:"노숙의 장기 전략", era:"208년", scene:"시상구",
      ...
      options:[
        { cji:"天", text:"20년 이상을 내다보는 큰 그림을 그린다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"단기 목표를 달성하며 장기 방향을 잡는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"전문가의 조언을 종합해 전략을 짠다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ci13", idiom:{word:"인재위본(人材爲本)", meaning:"인재가 사업의 근본이다 — 항상 후계를 준비하라"}, title:"주유의 죽음과 후계", era:"210년", scene:"강동",
      ...
      options:[
        { cji:"天", text:"항상 후계자를 준비해둔다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"복수의 인재를 동시에 육성한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"인재가 스스로 후계를 추천하게 한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci14", idiom:{word:"사생취의(捨生取義)", meaning:"목숨을 버리고 의를 취한다 — 의로움이 생명보다 크다"}, title:"조운의 충성", era:"208년", scene:"장판파",
      ...
      options:[
        { cji:"天", text:"군주가 먼저 부하를 가족처럼 대한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:97 },
        { cji:"地", text:"공정한 보상으로 헌신을 인정한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"대의와 명분으로 충성의 이유를 만든다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:92 },
      ] },
    { id:"ci15", idiom:{word:"이과격중(以寡擊衆)", meaning:"적은 수로 많은 수를 공격하는 용기와 지략"}, title:"장료의 합비 방어", era:"215년", scene:"합비성",
      ...
      options:[
        { cji:"天", text:"지휘관이 직접 선두에 선다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"결정적 승리를 하나 만들어 사기를 올린다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"철저한 방어 태세로 안전을 보장한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci16", idiom:{word:"위급지신(危急之臣)", meaning:"위기에 빛나는 신하가 진정한 충신이다"}, title:"허저의 조조 호위", era:"212년", scene:"동관 전투",
      ...
      options:[
        { cji:"天", text:"평소에 부하와 신뢰를 쌓는다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"위기 시 군주가 먼저 용기를 보인다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"충성에 반드시 보답한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci17", idiom:{word:"공수겸비(攻守兼備)", meaning:"공격과 수비를 모두 갖추어야 완전한 전력이다"}, title:"제갈량의 요새 구축", era:"229년", scene:"한중 방어선",
      ...
      options:[
        { cji:"天", text:"방어를 완벽히 한 후 공격에 나선다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"상황에 따라 유연하게 선택한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"항상 공격적 자세를 유지한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci18", idiom:{word:"겸허납언(謙虛納言)", meaning:"겸손하게 남의 말을 받아들이는 것이 지도자의 덕이다"}, title:"손권의 인재 사랑", era:"210년", scene:"강동 조정",
      ...
      options:[
        { cji:"天", text:"자신의 한계를 인정하고 도움을 청한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"인재의 공을 자신의 것으로 삼지 않는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"인재의 의견을 항상 경청한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ci19", idiom:{word:"도의지교(道義之交)", meaning:"도와 의리로 맺은 교우는 어떤 유혹도 흔들 수 없다"}, title:"조조의 관우 존중", era:"200년", scene:"하비성 투항 후",
      ...
      options:[
        { cji:"天", text:"같은 뜻과 가치관을 공유한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"인재가 원하는 환경과 역할을 만든다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"진심 어린 관계를 먼저 쌓는다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ci20", idiom:{word:"석별지정(惜別之情)", meaning:"진심으로 아쉬워하는 이별이 오히려 깊은 인연을 만든다"}, title:"유비의 서서 이별", era:"208년", scene:"신야",
      ...
      options:[
        { cji:"天", text:"진심으로 아쉬워하며 떠나도록 허락한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"붙잡아서 함께하도록 설득한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:82 },
        { cji:"人", text:"더 좋은 조건을 제시해 마음을 돌린다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci21", idiom:{word:"인재불인외(人才不認外)", meaning:"인재는 겉모습으로 판단할 수 없다"}, title:"방통의 재능 발굴", era:"211년", scene:"익주 입성 후",
      ...
      options:[
        { cji:"天", text:"다양한 기회를 주어 능력을 관찰한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"신뢰할 수 있는 사람의 추천을 경청한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"첫인상에 속지 않고 재평가한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci22", idiom:{word:"외교의 묘(外交之妙)", meaning:"외교는 칼보다 강하고 전쟁보다 효율적인 무기다"}, title:"마량의 외교 능력", era:"219년", scene:"동오 방문",
      ...
      options:[
        { cji:"天", text:"다양한 문화와 전략을 배우게 한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"실전 외교 경험을 쌓게 한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"탁월한 언변과 인품을 먼저 개발한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ci23", idiom:{word:"영웅불문출신(英雄不問出身)", meaning:"영웅은 출신을 묻지 않는다"}, title:"오나라 육손의 등장", era:"221년", scene:"이릉",
      ...
      options:[
        { cji:"天", text:"나이보다 능력과 잠재력을 본다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"전권을 주고 완전히 믿는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"경험자를 조언자로 붙여 보조한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci24", idiom:{word:"적장영입(敵將迎入)", meaning:"적장을 아군으로 만드는 것이 최고의 인재 영입이다"}, title:"강유의 항복과 재기", era:"234년", scene:"위나라 투항 후",
      ...
      options:[
        { cji:"天", text:"진심으로 환영하고 능력을 인정한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"귀순 인재에게 즉각 중요 임무를 준다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"관찰 기간을 두어 충성도를 확인한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ci25", idiom:{word:"권한위임(權限委任)", meaning:"적절한 위임이 조직의 역량을 최대화한다"}, title:"제갈량과 사마의의 인재 비교", era:"234년", scene:"오장원 대치",
      ...
      options:[
        { cji:"天", text:"믿을 수 있는 사람에게 전권을 준다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"핵심 결정만 직접 하고 나머지는 위임한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:92 },
        { cji:"人", text:"단계적으로 권한을 늘려간다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci26", idiom:{word:"삼인행필유아사(三人行必有我師)", meaning:"세 사람이 가면 그 중 반드시 나의 스승이 있다"}, title:"유비의 삼인방", era:"184년", scene:"탁군 의병",
      ...
      options:[
        { cji:"天", text:"각자의 강점이 서로 보완되도록 구성한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"같은 가치관과 목표를 공유하는 사람을 모은다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"능력보다 신뢰와 의리를 우선시한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:95 },
      ] },
    { id:"ci27", idiom:{word:"옥불탁불성기(玉不琢不成器)", meaning:"옥도 갈지 않으면 그릇이 되지 않는다 — 교육이 인재를 만든다"}, title:"조조의 청주 10만 군", era:"192년", scene:"청주",
      ...
      options:[
        { cji:"天", text:"기본기를 철저히 교육한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"실전 경험을 통해 빠르게 성장시킨다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"탁월한 지도자가 직접 훈련한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci28", idiom:{word:"불拘一格(불구일격)", meaning:"한 가지 틀에 얽매이지 않고 인재를 발굴한다"}, title:"손권의 젊은 장수 발탁", era:"200년", scene:"강동",
      ...
      options:[
        { cji:"天", text:"선입견 없이 새로운 인재를 평가한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"은거하거나 알려지지 않은 인재를 찾는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"내부 추천보다 외부 탐색을 병행한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci29", idiom:{word:"시스템이 인재보다 오래 간다(制度超越人才)", meaning:"좋은 시스템은 뛰어난 인재보다 오래 조직을 지탱한다"}, title:"제갈량의 팔진도", era:"223년", scene:"어복포",
      ...
      options:[
        { cji:"天", text:"자신이 없어도 작동하는 시스템을 만든다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"규칙과 매뉴얼로 지식을 조직화한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"훈련을 통해 시스템을 내재화한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci30", idiom:{word:"이적위우(以敵爲友)", meaning:"적을 친구로 만드는 것이 최고의 외교다"}, title:"마초의 귀순과 활용", era:"215년", scene:"한중",
      ...
      options:[
        { cji:"天", text:"즉각 중요 임무를 주어 신뢰를 보인다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"단계적으로 신뢰를 쌓으며 권한을 늘린다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"귀순 이유를 파악해 진심을 확인한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:82 },
      ] },
  ],
  ...
  2: [
    ...
    { id:"ct08", idiom:{word:"기회를 포착하라(把握機會)", meaning:"기회는 준비된 자에게만 온다"}, title:"적벽 화공의 승리", era:"208년", scene:"적벽",
      ...
      options:[
        { cji:"天", text:"적의 약점을 정확히 파악하고 집중 공격한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"자연을 활용해 최소 피해로 최대 효과를 낸다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"기습의 시기를 완벽하게 선택한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ct09", idiom:{word:"출기불의(出奇不意)", meaning:"예상치 못한 기발한 방법으로 적을 놀라게 한다"}, title:"오나라의 형주 기습", era:"219년", scene:"형주",
      ...
      options:[
        { cji:"天", text:"적의 방어 체계 허점을 철저히 분석한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"기만전술로 적의 시선을 다른 곳으로 돌린다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"신속하게 움직여 적이 반응할 시간을 주지 않는다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ct10", idiom:{word:"노당익장(老當益壯)", meaning:"늙어도 더욱 굳세다 — 경험이 용기를 완성한다"}, title:"한중 정군산 전투", era:"219년", scene:"정군산",
      ...
      options:[
        { cji:"天", text:"경험에서 나오는 판단력을 발휘한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"적이 방심하는 순간을 정확히 포착한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"담력과 결단으로 적의 핵심을 친다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct11", idiom:{word:"신속함이 핵심(迅速爲要)", meaning:"빠른 자가 느린 자를 이긴다 — 속도가 전략이다"}, title:"마초의 위남 전투", era:"211년", scene:"위수 북안",
      ...
      options:[
        { cji:"天", text:"신속한 이동으로 적이 반응할 틈을 주지 않는다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"결정적 승리를 연속으로 만들어 사기를 높인다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"적의 핵심 거점을 빠르게 점령한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct12", idiom:{word:"지리적 이점(地理之利)", meaning:"지형을 아는 자가 전투를 지배한다"}, title:"위나라의 오나라 침공", era:"222년", scene:"광릉",
      ...
      options:[
        { cji:"天", text:"지형의 특성을 최대한 이용한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"적이 지형 이점을 활용하기 전에 선점한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"지형 분석을 바탕으로 전술을 수립한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct13", idiom:{word:"패이위훈(敗而爲訓)", meaning:"실패를 교훈으로 삼으면 결국 승리한다"}, title:"촉한의 기산 1차 북벌", era:"228년", scene:"기산",
      ...
      options:[
        { cji:"天", text:"패인을 냉철히 분석하고 개선한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:85 },
        { cji:"地", text:"실패한 부분은 과감히 수정한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"성공한 부분은 강화하며 다시 시도한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:82 },
      ] },
    { id:"ct14", idiom:{word:"속전속결(速戰速決)", meaning:"빠른 전투로 빠른 결론을 낸다"}, title:"위나라의 요동 정복", era:"238년", scene:"요동",
      ...
      options:[
        { cji:"天", text:"목표를 명확히 하고 모든 자원을 집중한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"예상 기간의 반에 완수를 목표로 한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"항복 조건을 미리 제시해 저항을 최소화한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ct15", idiom:{word:"협력의 힘(協力之力)", meaning:"혼자 할 수 없는 것을 함께 이룬다"}, title:"손권의 위나라 침공 견제", era:"227년", scene:"합비 공방",
      ...
      options:[
        { cji:"天", text:"아군의 공격 시기에 맞춰 적을 분산시킨다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"독립적으로 움직이며 서로 보완한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"사전에 세밀한 협력 계획을 수립한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct16", idiom:{word:"양초지요(糧草之要)", meaning:"군량이 전쟁의 핵심이다 — 보급 없이는 승리도 없다"}, title:"제갈량의 2차 북벌", era:"228년", scene:"산관",
      ...
      options:[
        { cji:"天", text:"보급이 가능한 범위 내에서만 작전한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:85 },
        { cji:"地", text:"현지 조달을 최대화한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"신속하게 목표를 달성하고 철수한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct17", idiom:{word:"취약점공략(脆弱點攻略)", meaning:"적의 가장 약한 곳을 가장 강하게 치는 것이 전략의 핵심"}, title:"위나라 장합의 전략", era:"228년", scene:"가정",
      ...
      options:[
        { cji:"天", text:"적의 보급과 물자 흐름을 분석한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"방어의 빈틈을 정찰로 파악한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"심리적 약점을 이용한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct18", idiom:{word:"내부단결(內部團結)", meaning:"내부가 하나로 뭉쳐야 외부와 싸울 수 있다"}, title:"오나라의 산월 평정 완성", era:"230년", scene:"강동 산악",
      ...
      options:[
        { cji:"天", text:"내부 반란은 전방 전투보다 더 위험하다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"안정된 후방이 전방 보급의 기반이다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"내부 단결이 전투력의 배가(倍加) 효과를 낸다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct19", idiom:{word:"점진확장(漸進擴張)", meaning:"조급하지 않게 하나씩 쌓아가는 것이 진정한 확장이다"}, title:"촉한의 3차 북벌", era:"229년", scene:"무도·음평",
      ...
      options:[
        { cji:"天", text:"한 번에 많은 곳보다 확실히 지킬 수 있는 곳만 확보한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"점령지 안정화를 완료한 뒤 다음을 노린다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"전략적으로 중요한 거점을 우선 확보한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct20", idiom:{word:"수육병용(水陸竝用)", meaning:"물과 육지 모두를 활용해야 완전한 전력이 된다"}, title:"위나라의 동오 공략 실패", era:"234년", scene:"합비",
      ...
      options:[
        { cji:"天", text:"수군을 양성해 수로를 통해 공략한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:82 },
        { cji:"地", text:"장벽 우회 경로를 개발한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"내부 이탈자를 이용해 안에서 무너뜨린다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct21", idiom:{word:"자립이 최강(自立最强)", meaning:"남에게 의존하지 않는 것이 가장 강한 힘이다"}, title:"제갈량의 4차 북벌", era:"231년", scene:"기산 재도전",
      ...
      options:[
        { cji:"天", text:"자체 군량 생산 능력을 먼저 키운다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"보급을 담당할 믿을 수 있는 인재를 선발한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"여러 경로의 보급선을 확보한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct22", idiom:{word:"성동격서(聲東擊西)", meaning:"동쪽을 치는 척하며 서쪽을 공격한다"}, title:"손권의 산동 공략", era:"232년", scene:"요동 방면",
      ...
      options:[
        { cji:"天", text:"적의 후방과 측면을 동시에 위협한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"먼 동맹을 통해 적을 사방에서 압박한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"외교로 적의 동맹국을 이탈시킨다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct23", idiom:{word:"불굴의 의지(不屈之志)", meaning:"어떤 상황에서도 굽히지 않는 의지가 결국 역사를 만든다"}, title:"촉한의 5차 북벌", era:"234년", scene:"오장원 최후",
      ...
      options:[
        { cji:"天", text:"목표의 의미와 가치를 항상 상기한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"작은 성취를 통해 포기하지 않는 이유를 만든다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"동료의 격려로 서로 버팀목이 된다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct24", idiom:{word:"유시유종(有始有終)", meaning:"시작이 있으면 반드시 끝이 있어야 한다"}, title:"위나라의 오환 원정 완성", era:"207년", scene:"오환 백랑산",
      ...
      options:[
        { cji:"天", text:"중도 포기의 손실을 항상 계산한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"목표를 작게 나누어 단계적으로 완수한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"완수 후 성과를 명확히 평가한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ct25", idiom:{word:"우공이산(愚公移山)", meaning:"우공이 산을 옮기듯 포기하지 않고 방법을 바꿔 나아간다"}, title:"손권의 합비 재도전", era:"234년", scene:"합비성",
      ...
      options:[
        { cji:"天", text:"실패 원인을 분석해 다른 방법을 시도한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:82 },
        { cji:"地", text:"목표 자체가 옳은지 재검토한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"다른 방향에서 접근해 적의 허를 찌른다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ct26", idiom:{word:"청출어람(靑出於藍)", meaning:"제자가 스승보다 나아지는 것이 참된 계승이다"}, title:"강유의 1차 북벌", era:"240년", scene:"위나라 국경",
      ...
      options:[
        { cji:"天", text:"스승의 방식을 기반으로 자신만의 색을 더한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:85 },
        { cji:"地", text:"스승의 성공과 실패 모두에서 배운다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"스승보다 나아지려는 목표를 갖는다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct27", idiom:{word:"자강불식(自彊不息)", meaning:"스스로 강해지기를 멈추지 않는다"}, title:"위나라의 삼국 중 최강 군사력", era:"240년", scene:"낙양",
      ...
      options:[
        { cji:"天", text:"혁신을 멈추지 않는다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"내부 결속을 항상 다진다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"적을 절대 과소평가하지 않는다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ct28", idiom:{word:"양지탁세(量之度勢)", meaning:"형세를 헤아리고 능력을 재어 전략을 세운다"}, title:"촉한의 강유 9차 북벌", era:"253년", scene:"적도",
      ...
      options:[
        { cji:"天", text:"목표 대비 투입 비용을 냉철히 계산한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:82 },
        { cji:"地", text:"동료의 의견을 충분히 듣는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"외부 상황 변화를 놓치지 않는다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"ct29", idiom:{word:"출기제승(出奇制勝)", meaning:"기발한 전략으로 상대를 제압한다"}, title:"위나라 등애의 기습 성공", era:"263년", scene:"음평 절벽",
      ...
      options:[
        { cji:"天", text:"먼저 가능성을 확인하고 결단한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"실패를 두려워하지 않고 도전한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"핵심 인원의 완전한 헌신을 이끌어낸다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"ct30", idiom:{word:"최후의 결전(最後之決戰)", meaning:"결정적 순간에 모든 것을 걸어 완전한 승리를 거둔다"}, title:"진나라 통일 전쟁", era:"280년", scene:"장강 도하",
      ...
      options:[
        { cji:"天", text:"수군을 이용해 강 방어선을 무력화한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"여러 방면의 동시 공격으로 적을 분산시킨다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"내부 투항을 유도해 저항을 최소화한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
  ],
  ...
  3: [
    ...
    { id:"it07", idiom:{word:"계세지업(繼世之業)", meaning:"대를 이어 전해지는 사업이 가장 위대하다"}, title:"위나라의 3대 황제", era:"226년", scene:"낙양",
      ...
      options:[
        { cji:"天", text:"앞선 세대의 성취를 기반으로 더 나아간다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"앞선 세대의 실수를 반복하지 않는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"자신만의 새로운 비전을 만든다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"it08", idiom:{word:"충신보국(忠臣報國)", meaning:"충신은 군주보다 나라와 백성에게 충성한다"}, title:"제갈량의 군신 신뢰", era:"221년", scene:"성도",
      ...
      options:[
        { cji:"天", text:"군주의 부족함을 자신의 능력으로 보완한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"충성의 대상이 개인이 아닌 대의임을 인식한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"군주가 성장하도록 돕는다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"it09", idiom:{word:"명성이 무기다(名聲爲武器)", meaning:"훌륭한 명성은 살아서도 죽어서도 적을 제압한다"}, title:"사마의의 위장 병사", era:"234년", scene:"오장원",
      ...
      options:[
        { cji:"天", text:"적의 두려움을 이용해 행동을 통제한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"정확한 정보 없이 섣불리 행동하지 않는다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"신화와 명성을 전략적 자산으로 활용한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"it10", idiom:{word:"집분결합(集分結合)", meaning:"집권과 분권을 상황에 맞게 결합한다"}, title:"위나라의 중앙집권 강화", era:"235년", scene:"낙양",
      ...
      options:[
        { cji:"天", text:"핵심 결정은 집중하되 실행은 분권한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:85 },
        { cji:"地", text:"상황에 따라 유연하게 조정한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"제도로 균형을 제도화한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"it11", idiom:{word:"계승의 중요성(繼承之重)", meaning:"후계자 선정이 모든 대업의 성패를 결정한다"}, title:"손권의 말년 혼란", era:"250년", scene:"강동",
      ...
      options:[
        { cji:"天", text:"일찍 명확히 정하고 교육한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"복수 후보를 두되 명확한 기준을 세운다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"신뢰할 수 있는 원로 집단의 합의를 구한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"it12", idiom:{word:"배수진(背水陣)", meaning:"물을 등지고 싸우듯 최후의 각오로 임하는 결사의 전략"}, title:"강유의 마지막 계략", era:"264년", scene:"촉한 멸망 후",
      ...
      options:[
        { cji:"天", text:"성공 확률보다 실패 시 결과를 먼저 계산한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:85 },
        { cji:"地", text:"도박적 전략은 최후의 수단으로만 쓴다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:82 },
        { cji:"人", text:"다른 모든 방법이 없을 때만 시도한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:80 },
      ] },
    { id:"it13", idiom:{word:"여민안락(與民安樂)", meaning:"백성과 함께 편안하고 즐거운 세상을 만든다"}, title:"진나라 무제의 치세", era:"265년", scene:"낙양 진나라",
      ...
      options:[
        { cji:"天", text:"백성의 생활 안정을 최우선으로 한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"이전 체제의 유능한 인재를 포용한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"새 시대의 비전을 분명히 제시한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"it14", idiom:{word:"역사는 교훈이다(歷史爲訓)", meaning:"역사를 배우지 않으면 반드시 역사를 반복한다"}, title:"삼국의 흥망 교훈", era:"280년", scene:"역사의 흐름",
      ...
      options:[
        { cji:"天", text:"승자의 교만보다 패자의 지혜를 배운다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"역사를 반복하지 않으려면 끊임없이 배운다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"현재의 선택이 미래를 결정함을 인식한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:95 },
      ] },
    { id:"it15", idiom:{word:"영정치원(寧靜致遠)", meaning:"마음이 고요해야 멀리까지 나아갈 수 있다"}, title:"제갈량의 자녀 교육", era:"223년", scene:"성도",
      ...
      options:[
        { cji:"天", text:"뜻을 세우게 한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:95 },
        { cji:"地", text:"절제와 집중력을 기른다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"실제 경험을 통해 성장하게 한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"it16", idiom:{word:"두려움이 없는 자는 위험하다(無懼者危)", meaning:"두려움을 아는 자가 진정으로 강하다"}, title:"조조의 마지막 유언", era:"220년", scene:"낙양 임종",
      ...
      options:[
        { cji:"天", text:"더 뛰어난 전략을 가진 상대", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:90 },
        { cji:"地", text:"자신을 가장 잘 아는 책사의 부재", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:92 },
        { cji:"人", text:"민심의 이반", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:88 },
      ] },
    { id:"it17", idiom:{word:"외교는 국력이다(外交卽國力)", meaning:"외교 능력이 군사력만큼 중요한 국가의 힘이다"}, title:"손권의 외교 유산", era:"252년", scene:"강동 말기",
      ...
      options:[
        { cji:"天", text:"안정적인 외교 제도를 구축한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"차세대 외교 인재를 키운다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:85 },
        { cji:"人", text:"명확한 외교 원칙을 남긴다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    { id:"it18", idiom:{word:"민생이 천하다(民生卽天下)", meaning:"백성의 삶이 곧 천하의 모습이다"}, title:"삼국의 백성", era:"280년", scene:"천하",
      ...
      options:[
        { cji:"天", text:"백성의 일상에 관심을 갖는다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"백성의 고통을 직접 체험한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"백성이 원하는 것을 먼저 한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:95 },
      ] },
    { id:"it19", idiom:{word:"사필귀정(事必歸正)", meaning:"모든 일은 반드시 바른 곳으로 돌아간다"}, title:"역사의 반복", era:"280년", scene:"통일 후",
      ...
      options:[
        { cji:"天", text:"과거의 실수를 기록하고 교육한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:11,intel:6,ops:7,supply:7,military:10}, wisdomScore:88 },
        { cji:"地", text:"제도로 반복을 막는 시스템을 만든다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"끊임없이 개혁하며 정체를 방지한다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"it20", idiom:{word:"영웅의 기준(英雄之標)", meaning:"영웅은 이름이 아닌 행동으로 판단된다"}, title:"영웅의 조건", era:"280년", scene:"역사 앞에",
      ...
      options:[
        { cji:"天", text:"세상에 이로운 일을 한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:92 },
        { cji:"地", text:"자신보다 더 큰 것을 위해 헌신한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"후세에 교훈이 될 삶을 산다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:95 },
      ] },
    { id:"it21", idiom:{word:"천지인의 실천(天地人實踐)", meaning:"하늘의 항심, 땅의 베풂, 사람의 노력을 매일 실천한다"}, title:"창업과 삼국지", era:"현재", scene:"우리의 이야기",
      story:"삼국의 영웅들이 걸어간 길. 세상을 이롭게 하고, 초심을 잃지 않고, 진정성 있는 사람을 모아 천하를 통일하는 것. 그것이 오늘 우리의 사업이기도 하다.",
      question:"삼국지의 교훈을 현실에 적용하는 방법은?",
      options:[
        { cji:"天", text:"초심을 매일 기억하고 다짐한다", wisdom:"하늘의 항심으로 판단한다", effects:{personnel:12,intel:7,ops:8,supply:8,military:11}, wisdomScore:98 },
        { cji:"地", text:"진정성 있는 동료를 찾고 함께한다", wisdom:"땅의 베풂으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:95 },
        { cji:"人", text:"세상에 이로운 목표를 향해 꾸준히 나아간다", wisdom:"사람의 노력으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:97 },
      ] },
  ],
};
          ...
          <div className="fade">
            ...
            <div style={{padding:"0 16px"}}>
              <div style={box({textAlign:"center",padding:"20px 16px"})}>
                <div style={{fontSize:14,color:G.dim,letterSpacing:"0.2em",marginBottom:12}}>◈ 천지인(天地人)</div>
                <svg viewBox="0 0 300 262" style={{width:"100%",maxWidth:"300px",display:"block",margin:"0 auto"}}>
                  ...
                  <text x="86"  y="113" textAnchor="middle" fontSize="8.5" fill="#4a90d9" fontFamily="serif" opacity="0.9">하늘의 항심</text>
                  <text x="214" y="74"  textAnchor="middle" fontSize="22" dominantBaseline="middle">🌾</text>
                  <text x="214" y="98"  textAnchor="middle" fontSize="13" fontWeight="700" fill="#7ab040" fontFamily="serif">지(地)</text>
                  <text x="214" y="113" textAnchor="middle" fontSize="8.5" fill="#7ab040" fontFamily="serif" opacity="0.9">땅의 베풂</text>
                  <text x="150" y="170" textAnchor="middle" fontSize="22" dominantBaseline="middle">👥</text>
                  <text x="150" y="194" textAnchor="middle" fontSize="13" fontWeight="700" fill="#c8a030" fontFamily="serif">인(人)</text>
                  <text x="150" y="209" textAnchor="middle" fontSize="8.5" fill="#c8a030" fontFamily="serif" opacity="0.9">사람의 노력</text>
                  ...
                  return(
                    <button key={i} className={!chosen?"opt":""} onClick={()=>handleChoice(opt)} style={{
                      ...
                      <div style={{flexShrink:0,marginTop:1}}>
                        <div style={{fontSize:13,fontWeight:700,color:cjiInfo?.color||G.gold,border:`1px solid ${cjiInfo?.color||G.gold}`,borderRadius:3,padding:"1px 5px",letterSpacing:"0.05em"}}>{opt.cji==="天"?"천(天)":opt.cji==="地"?"지(地)":"인(人)"}</div>
                      </div>
                      <div style={{flex:1}}>
