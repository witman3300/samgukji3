  ...
  1: [
    ...
    { id:"ci11", idiom:{word:"충심(忠心)", meaning:"충성하는 마음은 어떤 상황에서도 변하지 않는다"}, title:"제갈량의 출사표 작성", era:"227년", scene:"성도",
      ...
      options:[
        ...
        { cji:"地", text:"말과 글로 분명히 표현한다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"묵묵히 맡은 바를 다한다", wisdom:"교이만물으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:90 },
      ] },
    ...
    { id:"ci13", idiom:{word:"인재위본(人材爲本)", meaning:"인재가 사업의 근본이다 — 항상 후계를 준비하라"}, title:"주유의 죽음과 후계", era:"210년", scene:"강동",
      ...
      options:[
        ...
        { cji:"地", text:"복수의 인재를 동시에 육성한다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"인재가 스스로 후계를 추천하게 한다", wisdom:"교이만물으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    ...
    { id:"ci15", idiom:{word:"이과격중(以寡擊衆)", meaning:"적은 수로 많은 수를 공격하는 용기와 지략"}, title:"장료의 합비 방어", era:"215년", scene:"합비성",
      ...
      options:[
        ...
        { cji:"地", text:"결정적 승리를 하나 만들어 사기를 올린다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"철저한 방어 태세로 안전을 보장한다", wisdom:"교이만물으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci16", idiom:{word:"위급지신(危急之臣)", meaning:"위기에 빛나는 신하가 진정한 충신이다"}, title:"허저의 조조 호위", era:"212년", scene:"동관 전투",
      ...
      options:[
        ...
        { cji:"地", text:"위기 시 군주가 먼저 용기를 보인다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"충성에 반드시 보답한다", wisdom:"교이만물으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci17", idiom:{word:"공수겸비(攻守兼備)", meaning:"공격과 수비를 모두 갖추어야 완전한 전력이다"}, title:"제갈량의 요새 구축", era:"229년", scene:"한중 방어선",
      ...
      options:[
        ...
        { cji:"地", text:"상황에 따라 유연하게 선택한다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"항상 공격적 자세를 유지한다", wisdom:"교이만물으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    ...
    { id:"ci20", idiom:{word:"석별지정(惜別之情)", meaning:"진심으로 아쉬워하는 이별이 오히려 깊은 인연을 만든다"}, title:"유비의 서서 이별", era:"208년", scene:"신야",
      ...
      options:[
        ...
        { cji:"地", text:"붙잡아서 함께하도록 설득한다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:82 },
        { cji:"人", text:"더 좋은 조건을 제시해 마음을 돌린다", wisdom:"교이만물으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    { id:"ci21", idiom:{word:"인재불인외(人才不認外)", meaning:"인재는 겉모습으로 판단할 수 없다"}, title:"방통의 재능 발굴", era:"211년", scene:"익주 입성 후",
      ...
      options:[
        ...
        { cji:"地", text:"신뢰할 수 있는 사람의 추천을 경청한다", wisdom:"계지자선으로 판단한다",   effects:{personnel:8,intel:11,ops:12,supply:11,military:10}, wisdomScore:90 },
        { cji:"人", text:"첫인상에 속지 않고 재평가한다", wisdom:"교이만물으로 판단한다", effects:{personnel:10,intel:10,ops:9,supply:8,military:10}, wisdomScore:85 },
      ] },
    ...
    { id:"ci26", idiom:{word:"삼인행필유아사(三人行必有我師)", meaning:"세 사람이 가면 그 중 반드시 나의 스승이 있다"}, title:"유비의 삼인방", era:"184년", scene:"탁군 의병",
      ...
      options:[
        ...
        { cji:"地", text:"같은 가치관과 목표를 공유하는 사람을 모은다", wisdom:"계지자선으로 판단한다",   effects:{personnel:7,intel:10,ops:11,supply:10,military:9}, wisdomScore:88 },
        { cji:"人", text:"능력보다 신뢰와 의리를 우선시한다", wisdom:"교이만물으로 판단한다", effects:{personnel:11,intel:11,ops:10,supply:9,military:11}, wisdomScore:95 },
      ] },
