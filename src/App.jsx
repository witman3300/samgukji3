...
const CHEONJIIN = [
  ...
  { key:"in",    hanja:"미(美)", name:"아름다운 삶", emoji:"🌸", color:"#c8a030",
...
const SITUATION_DB = {
  ...
  3: [
    ...
    { id:"it21", idiom:{word:"진선미의 실천(眞善美實踐)", meaning:"진실한 마음, 선한 행동, 아름다운 삶을 매일 실천한다"}, title:"창업과 삼국지", era:"현재", scene:"우리의 이야기",
